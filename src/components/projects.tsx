      ...
      <div className="grid grid-cols-2 grid-rows-2 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:px-96 px-10 md:mb-60 mb-20">
        ...
        <a href="https://github.com/Fenerz07/Tournoi-Pokemon-Java" target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden shadow-lg border border-gray-200 rounded-lg">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-90 items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
            <h2 className="bg-gradient-to-r from-pink-500 to-orange-500 text-center text-xl text-transparent bg-clip-text font-semibold">Jeu de simulation de combats POKEMON</h2>
            <Image 
        ...
        <a href="https://github.com/Fenerz07/phpSocialNetwork-" target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden shadow-lg border border-gray-200 rounded-lg">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-90  items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
            <h2 className="bg-gradient-to-r from-orange-500 to-yellow-500 text-xl text-transparent bg-clip-text text-center  font-semibold">Réseau social complet avec base de données</h2>
            <Image 
        ...
        <a href="https://github.com/Fenerz07/MovieTracker" target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden shadow-lg border border-gray-200 rounded-lg">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-90  items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
            <h2 className="bg-gradient-to-r from-yellow-500 to-slate-400 text-xl text-transparent bg-clip-text text-center  font-semibold">Traqueur de films stylisé avec utilisation de l&apos;API TMDB</h2>
            <Image 
        ...
        <a href="https://github.com/Fenerz07/viteNews" target="_blank" rel="noopener noreferrer" className="lg:col-start-1 relative group overflow-hidden shadow-lg border border-gray-200 rounded-lg">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-90  items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
            <h2 className="bg-gradient-to-r from-slate-400 to-blue-500 text-xl text-transparent bg-clip-text text-center font-semibold">Gestion et Affichage de News avec API Hacker News</h2>
            <Image 
              src="/images/vite.svg" 
              alt="Vite Logo" 
              className="w-8 h-8 mx-auto mt-2"
        ...
        <a href="https://github.com/Fenerz07/Puissance4-C" target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden shadow-lg border border-gray-200 rounded-lg">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-90  items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
            <h2 className="bg-gradient-to-r from-blue-500 to-purple-500 text-xl text-transparent bg-clip-text text-center  font-semibold">Puissance 4 en console à 2 joueurs concrets</h2>
            <Image 
              src="/images/c.svg" 
              alt="C Logo" 
              className="w-8 h-8 mx-auto mt-2"
        ...
        <a href="https://github.com/Fenerz07/Python/blob/main/Game%20of%20Life.py" target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden shadow-lg border border-gray-200 rounded-lg">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-90  items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
            <h2 className="bg-gradient-to-r from-purple-500 to-pink-500 text-xl text-transparent bg-clip-text text-center font-semibold">Jeu de la vie incontournable avec affichage graphique</h2>
            <Image 
